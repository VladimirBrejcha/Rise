...
final class DaysView: UIView, SelectableStackViewDelegate, NibLoadable {
    ...
    var snapshot: DaysCollectionView.Snapshot? { daysCollection.snapshot }
    private let cellProvider: DaysCollectionView.CellProvider
    ...
    private lazy var daysCollection: DaysCollectionView = {
        let collection = DaysCollectionView(
    ...
    init(cellProvider: @escaping DaysCollectionView.CellProvider, sectionTitles: [String]) {
    ...
    func applySnapshot(_ snapshot: DaysCollectionView.Snapshot) {
