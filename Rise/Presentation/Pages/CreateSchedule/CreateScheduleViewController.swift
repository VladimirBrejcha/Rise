    ...
    AlertPresentable
{
    ...
    enum Stage {
        ...
        case scheduleCreated(RequestNotificationPermissions)
        ...
        var vc: UIViewController {
            ...
            case let .wentSleep(wentSleepOutput, currentWentSleepTime):
                ...
                return controller
            case let .scheduleCreated(requestNotificationPermissions):
                let controller = Storyboard.createSchedule.instantiateViewController(
                    of: ScheduleCreatedCreateScheduleViewController.self
                )
                controller.requestNotificationPermissions = requestNotificationPermissions
                return controller
            }
        }
    }
