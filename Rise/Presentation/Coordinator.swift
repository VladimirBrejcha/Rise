...
//
    ...
    final class RootCoordinator {
        ...
        func run() {
            ...
            updateActiveViewControllerForNotifications()
        ...
        func updateActiveViewControllerForNotifications() {
            guard let activeViewController = getTopViewController() else { return  }
            useCases.notifyToSleep.setNotificationActiveViewController(activeViewController)
            useCases.notifyToSleep.setPermissionViewControllerIfNeeded(permissionViewController)
           }
