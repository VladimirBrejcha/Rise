...
//    
//    // MARK: - Confirm plan -
//    static func confirm(plan: PersonalPlan) throws -> PersonalPlan {
//        guard let dailyTimes = getDailyTime(for: plan, and: Day.today.date) else {
//            throw RiseError.unknownError()
//        }
//        var plan = plan
//        plan.latestConfirmedDay = dailyTimes.sleep
//        
//        return plan
//    }
//    
//    static func isConfirmed(plan: PersonalPlan) -> Bool {
//        if plan.paused { return true }
//        let dailyTimes = getDailyTime(for: plan, and: Day.yesterday.date)
//        return plan.latestConfirmedDay >= dailyTimes!.day // todo force unwrap
//    }
//    
//    static func isConfirmed(for day: Day, plan: PersonalPlan) -> Bool {
//        if plan.paused { return true }
//        return plan.latestConfirmedDay >= calendar.date(bySettingHour: 12, minute: 00, second: 00, of: calendar.startOfDay(for: day.date))!
//    }
//    
//    // MARK: - Pause plan -
...
//        var date = calendar.date(bySettingHour: 12, minute: 00, second: 00, of: calendar.startOfDay(for: date))!
//        if plan.paused {
...
//            return nil
//            
//        } else if daysSincePlanStart == 0 {
//            let sleepTime = plan.dateInterval.start
...
//            )
//            
//        } else if daysSincePlanStart > getPlanDuration(for: plan) {
...
//            let sleepTime = plan.dateInterval.start.addingTimeInterval(timeShiftSec).appending(days: daysSincePlanStart + 1)!
//            let wakeTime = sleepTime.addingTimeInterval(plan.sleepDurationSec).appending(days: -1)!
//            return DailyPlanTime(
//                day: date,
//                wake: wakeTime,
//                sleep: sleepTime
...
//            [.day],
//            from: calendar.date(bySettingHour: 12, minute: 00, second: 00, of: calendar.startOfDay(for: plan.dateInterval.start))!,
//            to: calendar.date(bySettingHour: 12, minute: 00, second: 00, of: calendar.startOfDay(for: plan.latestConfirmedDay))!
//        ).day ?? 0
//    }
//    
