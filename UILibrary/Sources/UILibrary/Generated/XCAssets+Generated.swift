...
public enum Asset {
  public enum Colors {
    ...
    public static let defaultContainerBackground = ColorAsset(name: "DefaultContainerBackground")
    public static let lightBlue = ColorAsset(name: "LightBlue")
    public static let red = ColorAsset(name: "Red")
    public static let violet = ColorAsset(name: "Violet")
    public static let white = ColorAsset(name: "White")
    public static let whiteSeparator = ColorAsset(name: "WhiteSeparator")
  }
  ...
  public static let wakeup = ImageAsset(name: "wakeup")
}
