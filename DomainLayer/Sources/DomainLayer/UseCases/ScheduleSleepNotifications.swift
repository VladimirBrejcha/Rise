...
public protocol HasScheduleSleepNotifications {
    var scheduleSleepNotifications: ScheduleSleepNotifications { get }
}
    ...
    UNUserNotificationCenterDelegate
{
    ...
    init(getSchedule: GetSchedule,
        ...
        super.init()
        self.cancellable = scheduleRepository.publisher()
    ...
    func generateSleepNotification(for date: Date, index: Int) {
        ...
        notificationManager.createNotification(
            ...
            categoryIdentifier: "SleepCategory",
            identifier: "time-to-sleep-\(index)"
        )
    }
